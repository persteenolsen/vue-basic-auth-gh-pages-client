...
<template>
  ...
  <div>
   ...
   This Vue.js + Vuex SPA Client at GitHub Pages work together with a secure ASP.NET Core 2.2 Web API at Azure App Service doing Basic Authentication 
   <br/> <br/>
  ...
  <b>Hosting</b>
  <ul>
    <li>The Vue.js + Vuex SPA client is hosted at GitHub Pages</li>
